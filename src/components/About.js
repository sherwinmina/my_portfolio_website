        ...
        <Grid id="right" mobile={16} tablet={16} computer={16}>
          ...
          <Container text id="about">
            <p style={{ textIndent: '20px' }}>
              ...
              Francisco, CA. Currently working with React, Redux, Webpack and
              Node. My interests are in front-end development but I also like
              being involve in the entirety of a project.
            </p>
            <p style={{ textIndent: '20px' }}>
              I have a keen interest in graphic design, and I'm passionate about
              crafting great experiences for end-users. These influence all of
              my decisions as I work on a project, be they technical or
              aesthetic, and I'm always on the lookout for new ideas that can
              help better shape projects.
            </p>
            <p>
              Constantly learning, seeking new challenges and still in search
