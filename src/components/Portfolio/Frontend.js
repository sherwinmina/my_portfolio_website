...
const Calculator = () => 
  ...
  const ImperfectProduce = () => <Grid celled="internally" stackable className="box" columns={7}>
      <Grid.Row className="box">
        <Grid.Column className="left" width={7}>
          <Image size="large" src={require("../../../public/projects/weather-chart.jpg")} />
        </Grid.Column>
        <Grid.Column className="right" width={9}>
          <div className="content">
            <div id="title">
            ...
            <p>
              A practice front-end copy of the current design and flow the
              Imperfect Produce application
            </p>
            ...
            <Button.Group style={{ paddingTop: "12px" }}>
              <Button attached="left">
                {" "}
                <a href="https://github.com/sherwinmina/imperfect-produce" target="_blank">
                  Source Code
                </a>
              </Button>
              <Button attached="right">
